...
namespace WebApiUebungen
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var serverBuilder = options.UseSqlServer("Server=(localdb)\\MSSqlLocalDB;Integrated Security=true;Database=WebApiDemo;");
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebApiUebungen", Version = "v1" });
            });
        }
